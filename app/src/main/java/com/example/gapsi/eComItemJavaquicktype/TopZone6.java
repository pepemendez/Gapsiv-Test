...
public class TopZone6 {
    ...
    private TopZone6Configs configs;
    ...
    public TopZone6Configs getConfigs() { return configs; }
    @JsonProperty("configs")
    public void setConfigs(TopZone6Configs value) { this.configs = value; }
}
