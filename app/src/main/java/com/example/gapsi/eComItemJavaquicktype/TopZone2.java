...
public class TopZone2 {
    ...
    private TopZone2Configs configs;
    ...
    public TopZone2Configs getConfigs() { return configs; }
    @JsonProperty("configs")
    public void setConfigs(TopZone2Configs value) { this.configs = value; }
}
