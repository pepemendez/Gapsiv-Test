...
public class TopZone3 {
    ...
    private TopZone3Configs configs;
    ...
    public TopZone3Configs getConfigs() { return configs; }
    @JsonProperty("configs")
    public void setConfigs(TopZone3Configs value) { this.configs = value; }
}
