...
public class BottomZone2 {
    ...
    private BottomZone2Configs configs;
    ...
    public BottomZone2Configs getConfigs() { return configs; }
    @JsonProperty("configs")
    public void setConfigs(BottomZone2Configs value) { this.configs = value; }
}
