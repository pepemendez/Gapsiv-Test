...
public class TopZone5 {
    ...
    private TopZone5Configs configs;
    ...
    public TopZone5Configs getConfigs() { return configs; }
    @JsonProperty("configs")
    public void setConfigs(TopZone5Configs value) { this.configs = value; }
}
