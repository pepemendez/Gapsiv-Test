...
public class TentacledModule {
    ...
    private TentacledConfigs configs;
    ...
    public TentacledConfigs getConfigs() { return configs; }
    @JsonProperty("configs")
    public void setConfigs(TentacledConfigs value) { this.configs = value; }
}
