...
public class PillsTopZone {
    ...
    private PillsTopZoneConfigs configs;
    ...
    public PillsTopZoneConfigs getConfigs() { return configs; }
    @JsonProperty("configs")
    public void setConfigs(PillsTopZoneConfigs value) { this.configs = value; }
}
